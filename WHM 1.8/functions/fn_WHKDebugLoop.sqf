...
//when debug is active, all machines send a count of their locla units to the debugger(s)
...
while {true} do
{
	...
	if (WHKDEBUGHC) then
	{
		...
		//[[3,[profileName,_localCount]],"Werthles_fnc_WHKDebugHint",WHKDEBUGGER,false] call BIS_fnc_MP;
